...
export class SalesmenService {
    ...
    getSalesmen(): Observable<HttpResponse<SalesmenDatapoint[]>> {
        ...
        return this.http.get<SalesmenDatapoint[]>(url, {
            observe: 'response',
    ...
    getPerformanceRecords(
        sid: number
    ): Observable<HttpResponse<PerformanceDatapoint[]>> {
        const url = `${environment.apiEndpoint}/api/salesmen/${sid}/performance`;
        return this.http.get<PerformanceDatapoint[]>(url, {
            observe: 'response',
            withCredentials: true,
        });
    }

    getSalesmanPerformanceByYear(
        sid: number,
        year: number
    ): Observable<HttpResponse<PerformanceDatapoint>> {
    ...
    addPerformanceRecord(
        sid: number,
        record: { sid: number; year: number; competences: Competence[] }
    ...
    getSalesOrdersByGovernmentIdAndYear(
        gid: number,
        year: number
    ): Observable<HttpResponse<ProductSalesDatapoint[]>> {
